...
async function fillModalInfo(driver) {
  ...
  await driver.findElement(By.name("firstname")).sendKeys("Anastasia", Key.RETURN);
  await driver.findElement(By.name("lastname")).sendKeys("Vinohradova", Key.RETURN);

  const email = "fanastasia008@email.com";
  ...
  const password = "A12S34DFSesRRe32423SSDF4";
  await driver
